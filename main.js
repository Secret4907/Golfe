...
function my_keydown(e)
{
	...
	function up()
	{
		...
		console.log("autura do bloco da imagem =" + block_image_height)
	    console.log("Quando a seta para cima é prssionada, X = " + ball_x + ", Y ="+ball_y)
		canvas.remove(ball_obj)
		new_image()
	}
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("autura do bloco da imagem =" + block_image_width)
			console.log("Quando a seta para cima é prssionada, X = " + ball_x + ", Y ="+ball_y)
			canvas.remove(ball_obj)
			new_image()
		}
